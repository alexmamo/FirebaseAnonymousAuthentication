...
![alt text](https://i.ibb.co/q5PDH5B/Screenshot-20211129-145442-Large.png)
![alt text](https://i.ibb.co/DfXPvMb/Screenshot-20211129-145452-Large.png)
...
* [How to handle Firebase Authentication in clean architecture using Jetpack Compose?][10]

See it also on youtube:

* https://youtu.be/bekW_W3A2EY
